...
<header>
    <div id="top_line">
        <div class="container">
            <div class="row">
                <div class="col-6"><i class="icon-phone"></i><strong>+38(099)217-5697</strong>
                </div>
                <div class="col-6">
                    <ul id="top_links" style="margin-top: -15px;">
                        ...
                        @else
                            <li class="nav-item dropdown" id="hover-dropdown">
                                @auth
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end" style="background-color: #1b6d85;" aria-labelledby="navbarDropdown">
                                        @if(Auth::check() && (Auth::user()->role_id == 1 || Auth::user()->role_id == 3 || Auth::user()->role_id == 2))
                        ...
                        @endguest
                            ...
                            <li><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-basket" viewBox="0 0 16 16">
            ...
            <div class="tab-pane active show" id="tours">
                <form action="{{ route('search') }}" method="GET" id="home-search-form">
                    <div class="row no-gutters custom-search-input-2 justify-content-between">
                        <div class="col-lg-10">
                            <input class="form-control date-pick" id="what" type="text" name="what"
                                   placeholder="{{ __('translate.What') }}...">
                        </div>
...
<div class="container">
    <div class="row">
        <div class="col-md-2 m-auto">
            <a href="">
                <img style="max-width: 100%" src="storage/Home_files/site_logo.png">
            </a>
        </div>
        <div class="col-md-4">
