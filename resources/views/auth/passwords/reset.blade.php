            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="row mb-3">
                            <label for="password" style="color: #0a0e14;" class="col-md-4 col-form-label text-md-end">{{ __('Password') }}</label>
                            <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                            <label for="password-confirm" style="color: #0a0e14;" class="col-md-4 col-form-label text-md-end">{{ __('Confirm Password') }}</label>
                            <div class="col-md-6">
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn_full ladda-button" style="background-color: #5a5b5d;" >
                                    {{ __('Reset Password') }}
                                </button>
                            </div>
                        </div>
