...
<head>
    ...
    <title>{{ config('app.name', 'EVENTHES') }} - Contact US</title>
    ...
    <style>
        ...
        @media (min-width: 768px) {
            .test-mobile-only {
                display: none; /* Скрываем поле "test" на устройствах с шириной экрана 768px и больше */
            }
        }
    </style>
                ...
                <div class="col-6">
                    @guest
                        <ul id="top_links" style="margin-top: -15px;">
                            @if (Route::has('login'))
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('login') }}"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-door-closed" viewBox="0 0 16 16">
                            ...
                            @endif
                            @else
                                <ul id="top_links" style="margin-top: -5px;">
                                    <li class="nav-item">
                                    @auth
                                        <li style="margin-top: -25px;">
                                            @if(Auth::check() && (Auth::user()->role_id == 1 || Auth::user()->role_id == 3 ))
                                                <a href="/admin" target="_blank">
                                                    ...
                                                    </i> Dashboard <span class="badge badge-danger" id="orders-alerts"></span>&nbsp;&nbsp;<span class="badge badge-warning"><span style="color: white;">1</span></span>
                                                </a>
                                            @else
                                                <a href="/client">
                                                    <i>
                                    ...
                                    <li id="cart-count">
                                        <a href="#" type="button" data-bs-toggle="modal" data-target="#trTR">
                                            ...
                                            <span id="cart-item-count">{{ $cartCount > 0 ? $cartCount : '' }}</span>
                                        </a>
                                    </li>
                                    <li id="cart-countDoing">
                                        <a href="#" type="button" data-bs-toggle="modal" data-target="#trDoing">
                    ...
                    <ul>
                        @if(Auth::check() && (Auth::user()->role_id == 1 || Auth::user()->role_id == 3  ))
                            <li class="nav-item active">
                                <a  href="/client" target="_self">
                                    <i aria-hidden="true"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
                                            <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6m2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0m4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4m-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10s-3.516.68-4.168 1.332c-.678.678-.83 1.418-.832 1.664z"/>
                                        </svg></i>  {{ __('translate.Cabinet') }}
                                </a>
                            </li>
                        @else
                            <li class="nav-item active">
                        ...
                        <li class="nav-item" >
                            <a style="background-color: #0d6efd; height: 21px;  border-radius: 4px;" class="nav-link" href="/all" >
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                               data-bs-toggle="dropdown" aria-expanded="false">
                                <span>  <img width="29" height="29" src="{{asset('storage/files/'.session('locale',config('app.locale')).'.png')}}" alt="Flag" ></span>
                            </a>
                        ...
                        <li>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <button type="button" class="btn btn-success" onclick="location.href='/admin'">+ Створити</button>
                        </li>
                    </ul>
                </div>
                {{--                <ul id="top_tools">--}}
...
<div class="white_bg">
    ...
    <div class="container margin_60">
        <div class="main_title">
            <h2 class="section-title">{{ __('translate.best_service_title') }}</h2>
                ...
                <div class="container">
                    <div class="row">
                        <div class="block87__content">
                            <div class="row">
                                <div class="col-12">
                                    <h4><span>{{ __('translate.eventhes_bonuses') }}</span></h4>
                                    <p>{{ __('translate.eventhes_description') }}</p>
                                    <p>{{ __('translate.eventhes_join') }}</p>
                                    <p>{{ __('translate.eventhes_registration') }}</p>
                                    <h4><span>{{ __('translate.eventhes_join_today') }}</span></h4>
        ...
        <style>
            .promo_full {
                background-image: url({{ asset('storage/files/1277.jpg') }});
        ...
        <div class="container margin_60">
            <div class="main_title">
                <h2>{{ __('translate.Our') }} <span>{{ __('translate.statistics') }}</span></h2>
            </div>
            <div class="row"  style="background-color: #ededed; border-radius: 6px;">
                <div class="row" style="width:100%;">
                    <div class="col-lg-3 col-md-6 text-center">
                        <h4><span>{{ __('translate.Views users') }}</span> 12 784</h4>
                    </div>
                    <div class="col-lg-3 col-md-6 text-center">
                        <h4><span>{{ __('translate.Quick events') }} </span>27 980</h4>
                    </div>
                    <div class="col-lg-3 col-md-6 text-center">
                        <h4><span>{{ __('translate.Paymant events') }}</span> 890 000</h4>
                    </div>
                    <div class="col-lg-3 col-md-6 text-center">
                        <h4><span>{{ __('translate.Country') }}</span> 12</h4>
                    </div>
                </div>
            </div>
            <div class="main_title">
            ...
            <style>
                /* Применяется только на мобильных устройствах */
                @media (max-width: 767px) {
                    .col-md-6-6-6 {
                        margin-top: 55%;
                    }
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="promo_full_wp magnific">
                        <video autoplay muted loop id="video-bg" style="border-radius: 5px;">
                            <source src="{{ asset('storage/files/19795.mp4') }}" type="video/mp4">
                            {{ __('translate.Your browser does not support HTML5 video.') }}
                        </video>
                    </div>
                </div>
                <div class="col-md-6-6-6" >
                    <h3><span>Eventhes</span> {{ __('translate.helps you become better') }} </h3>
                    <ul class="list_order">
                        <li><span>1</span>{{ __('translate.Earnings for views') }}</li>
                        <li><span>2</span>{{ __('translate.Individual event page') }}</li>
                        <li><span>3</span>{{ __('translate.Modern event management functionality') }}</li>
                        <li><span>4</span>{{ __('translate.Intuitive control panel') }}</li>
...
<div class="container margin_60" >
    ...
    <div class="row">
        <div class="col-lg-6 wow fadeIn" data-wow-delay="0.3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeIn;">
            <div class="feature"><i><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-info-circle" viewBox="0 0 16 16">
        ...
        <div class="col-lg-6 wow fadeIn" data-wow-delay="0.4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeIn;">
            <div class="feature"><i><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-translate" viewBox="0 0 16 16">
...
<script src="/torage/Home_files/cat_nav_mobile.js"></script>
<script>
    $('#cat_nav').mobileMenu();
</script>
<script>
