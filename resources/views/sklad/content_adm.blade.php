                ...
                <div class="sklad-body">
                    ...
                    <div class="container-fluid px-0" id="operationBlock">
                        <div class="sklad-actions">
                            <button type="button" class="sklad-btn-refresh" onclick="location.reload()"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 32 32">
