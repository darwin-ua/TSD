            ...
            <nav class="col-9">
                ...
                <div class="main-menu" style="margin-top:-10px;">
                    ...
                    <ul>
                        ...
                        <li>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <button type="button" class="btn btn-success" onclick="location.href='/sklad'">+ {{ __('translate.CreateEvents') }}</button>
                        </li>
                    </ul>
                </div>
                {{--                <ul id="top_tools">--}}
...
<!-- End Header -->
<section id="search_container" style="background-color:#ffffff;background-repeat: round">
        ...
        <div class="row justify-content-center">
            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-8">
                <div id="login" style="border-radius: 5px;">
                    ...
                    <hr>
                    <center><span class="btn_full_outline" style="margin-top: 10px; text-decoration: none;" >
                       <p>support@eventhes.com</p>
                        <p>admin@eventhes.com</p>
                    </span></center>
                </div>
            </div>
        </div>
...
<script>
    ...
    if (currentUrl === "/sklad" || currentUrl === "/sklad/") {
        document.querySelector('.nav-item a[href="/sklad"]').classList.add('active');
    }
